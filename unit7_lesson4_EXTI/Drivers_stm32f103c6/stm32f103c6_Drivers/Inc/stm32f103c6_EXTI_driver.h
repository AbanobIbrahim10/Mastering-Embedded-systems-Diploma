...
typedef struct
{
	EXTI_GPIO_MAPPING_t 	EXTI_PIN;				//specify the EXTI GPIO Mapping
													//This parameter must be set based on @ref EXTI_define

	uint8_t					EXTI_Trigger_Sense;		//This parameter must be set based on @ref EXTI_Trigger_define

	uint8_t					EXTI_IRQ_EN;			//Enable IRQ Mask in EXTI peripheral and IRQ Mask in NVIC peripheral
													//This parameter must be set based on @ref EXTI_IRQ_define
	void(*EXTI_Ptr_Function_CallBack)(void);		//put here the function which will be called when EXTI occur

}EXTI_PIN_CONFIG_t;

/***************************/
/*MACROS CONFIGRATION LEVEL*/
/***************************/
#define EXTI0 	0
#define EXTI1 	1
#define EXTI2 	2
...
#define	EXTI_Trigger_Rising_falling_edge	2
